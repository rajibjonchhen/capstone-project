...
function ForCreatorInvestor() {
  ...
  return (
      ...
      <Container className="role-box w-100">
        <Row className="d-flex">
          {roleArray.map((role, i) => (
            ...
            >
              <p className=" mr-auto">
                <span className="text-white text-for-the ">For the</span>{" "}
                <span className="highlight-role ml-auto">
